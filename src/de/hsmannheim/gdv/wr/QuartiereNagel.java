...
public class QuartiereNagel extends PApplet {
	...
	public void setup() {
		  ...
		  */
		  ...
		  /*
		  dataEntriesMap = loadSalaryFromCSV("medeinkommenquartier.csv");
		  for(Marker marker : markers) {
...
//		    float alpha = map(dataEntry.value, 0, 700, 10, 255);
		...
		public static void main(String[] args) {
			PApplet.main(new String[] { QuartiereNagel.class.getName() });
		}
}
